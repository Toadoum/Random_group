import random
ma_list =["SEV","KAGON","TAHI","TEMA","HAMZ","Hassane","Hypolite","Issa","Innocent","Julie","Lagré","Mahamat","Narcisse","Nil","Payang","Seraphin","Severin","jules","kevin"]
